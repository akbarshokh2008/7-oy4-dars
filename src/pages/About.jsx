  ...
  return (
    <div className='flex justify-center items-center pt-20 flex-col'>
      <div className='sarlav flex gap-6'>
        <h1 className='text-[#394E6A] text-6xl font-bold dark:text-white'>
          We love{' '}
        </h1>
        <span className='px-6 py-4 bg-blue-500 font-bold  dark:bg-[#FF7AC6] dark:text-[#301C27] text-3xl rounded-2xl text-white'>
          comfy
        </span>
      </div>
